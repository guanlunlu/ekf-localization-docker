...
if("TRUE" STREQUAL "TRUE")
  set(robot_navigation_SOURCE_PREFIX /root/euro_ws/src/robot_navigation)
  set(robot_navigation_DEVEL_PREFIX /root/euro_ws/devel)
  ...
  set(robot_navigation_INSTALL_PREFIX /root/euro_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/euro_ws/src/robot_navigation/${idir}'.  ${_report}")
    endif()
